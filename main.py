...
if __name__ == "__main__":
    ...
    #
    # sheldun = Schedule()
    # sheldun.add_module(datetime.date(2021, 1, 17), module, 1)
    # sheldun.add_module(datetime.date(2022, 5, 17), module, 1)
    # sheldun.add_module(datetime.date(2021, 7, 17), module, 1)
    # sheldun.add_module(datetime.date(2021, 1, 17), module, 2)
    # sheldun.add_module(datetime.date(2021, 1, 17), module, 1)
